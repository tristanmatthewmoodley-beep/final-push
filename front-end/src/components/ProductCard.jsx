  ...
  return (
    <div className="card group">
      <div className="relative overflow-hidden rounded-lg mb-4">
        ...
        {/* Action buttons */}
        <div className="absolute bottom-2 right-2 flex space-x-2 opacity-0 group-hover:opacity-100 md:transition-opacity transition-opacity duration-200 md:opacity-0 opacity-100">
          <button
            onClick={handleWishlistToggle}
            className={`p-2 rounded-lg transition-colors touch-manipulation ${
              isInWishlist(product.id)
                ? 'bg-red-500 text-white'
                : 'bg-white/90 text-car-black hover:bg-white active:bg-white'
            }`}
          >
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            disabled={!inStock}
            className="bg-white text-car-black p-2 rounded-lg hover:bg-gray-100 active:bg-gray-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed touch-manipulation min-h-[44px] min-w-[44px] flex items-center justify-center"
          >
