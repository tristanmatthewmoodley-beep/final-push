    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const productData = {
          ...
          // Ensure images array has at least one placeholder if empty
          images: finalFormData.images.length > 0 ? finalFormData.images : [{ url: 'https://via.placeholder.com/400x300?text=No+Image', alt: 'No image available', isPrimary: true }]
        };
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <ImageUpload
                ...
                onImagesChange={(newImages) => setFormData({
                  ...formData,
                  images: newImages
                })}
                maxImages={5}
                multiple={true}
                className="bg-car-gray border border-gray-600 rounded-lg p-4"
              />
            </div>
